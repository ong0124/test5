...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1 class="absolute left-1/2 transform -translate-x-1/2 text-lg capitalize text-white">${ssrInterpolate(_ctx.$t("confirmationPage.title"))}</h1></header><div class="m-3 pt-4 pb-8 rounded-lg bg-white"><div class="px-4"><div class="px-2"><p class="border-l-4 border-orange-400 pl-2">${ssrInterpolate(unref(t)("confirmationPage.tripInfo"))}</p><p class="my-2">${ssrInterpolate(("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(unref(form).shuttle_date))} ${ssrInterpolate(unref(form).shuttle_time)}</p><div class="flex justify-between"><div class="flex"><p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).departure_loc))}</p>`);
      _push(ssrRenderComponent(_component_Icon, {
        name: "material-symbols-arrow-right-alt",
        class: "mx-2 w-6 h-6"
      }, null, _parent));
      _push(`<p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).destination_loc))}</p></div><div class="flex-col text-center"><p>${ssrInterpolate(isSwapped.value ? _ctx.$t("Booking.ferryTime") : _ctx.$t("Booking.flightTime"))}</p><p>${ssrInterpolate(isSwapped.value ? unref(form).ferry_time : unref(form).flight_time)}</p></div></div></div>`);
      _push(ssrRenderComponent(_component_DashLine, null, null, _parent));
      if (unref(form).trip_type === "roundTrip") {
        _push(`<div><div class="p-2"><p class="border-l-4 border-orange-400 pl-2">${ssrInterpolate(_ctx.$t("confirmationPage.returnTripInfo"))}</p><p class="my-2">${ssrInterpolate(("formatDate" in _ctx ? _ctx.formatDate : unref(formatDate))(unref(form).return_shuttle_date))} ${ssrInterpolate(unref(form).return_shuttle_time)}</p><div class="flex justify-between"><div class="flex"><p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_departure))}</p>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "material-symbols-arrow-right-alt",
          class: "mx-2 w-6 h-6"
        }, null, _parent));
        _push(`<p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_destination))}</p></div><div class="flex-col text-center"><p>${ssrInterpolate(isSwapped.value ? _ctx.$t("Booking.flightTime") : _ctx.$t("Booking.ferryTime"))}</p><p>${ssrInterpolate(isSwapped.value ? unref(form).flight_time : unref(form).ferry_time)}</p></div></div></div>`);
        _push(ssrRenderComponent(_component_DashLine, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
...
//# sourceMappingURL=_id_-CQ2rWXfO.mjs.map

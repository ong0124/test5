...
import { c as useLocalePath, b as _export_sfc, _ as __nuxt_component_2$1 } from './server.mjs';
import { defineComponent, useSSRContext, mergeProps, withCtx, createVNode, createTextVNode, toDisplayString } from 'vue';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<h1 class="absolute left-1/2 transform -translate-x-1/2 text-lg capitalize text-white">${ssrInterpolate(_ctx.$t("paymentPage.title"))}</h1></header></div><main class="flex-1 container mx-auto px-4 py-6 max-w-md"><div class="mb-8"><h2 class="text-lg font-medium text-gray-700 mb-4 flex items-center ml-2 space-x-2 leading-none">`);
  ...
  _push(` ${ssrInterpolate(_ctx.$t("paymentPage.OrderTotal"))}</h3><div class="space-y-3"><div class="flex justify-between text-gray-600"><span>${ssrInterpolate(_ctx.$t("paymentPage.OrderAmount"))}</span><span>NT$ 300.00</span></div><div class="flex justify-between text-gray-600"><span>${ssrInterpolate(_ctx.$t("paymentPage.redEnvelope"))}</span><span>- NT$ 2.00</span></div><div class="flex justify-between text-gray-600"><span>paymentPage.service_fee</span><span>NT$ 0.00</span></div><div class="border-t border-gray-200 my-2"></div><div class="flex justify-between font-semibold text-gray-600"><span>${ssrInterpolate(_ctx.$t("paymentPage.total"))}</span><span class="text-green-600">NT$ 298.00</span></div></div></div></main><div class="sticky bottom-12 bg-white py-4 px-6 shadow-lg border-t border-gray-100">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(` ${ssrInterpolate(_ctx.$t("paymentPage.pay_button"))} (NT$ 298) `);
      } else {
        return [
          ...
          createTextVNode(" " + toDisplayString(_ctx.$t("paymentPage.pay_button")) + " (NT$ 298) ", 1)
        ];
      }
    }),
    _: 1
...
//# sourceMappingURL=payment-B2TVhsVb.mjs.map

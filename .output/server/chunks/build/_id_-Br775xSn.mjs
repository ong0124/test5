...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).destination_loc))}</p></div><div><p>${ssrInterpolate(isSwapped.value ? _ctx.$t("Booking.ferryTime") : _ctx.$t("Booking.flightTime"))} : ${ssrInterpolate(isSwapped.value ? unref(form).ferry_time : unref(form).flight_time)}</p></div></div></div>`);
      ...
      if (unref(form).trip_type === "roundTrip") {
        ...
        _push(`<p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_destination))}</p></div><div><p>${ssrInterpolate(isSwapped.value ? _ctx.$t("Booking.flightTime") : _ctx.$t("Booking.ferryTime"))} : ${ssrInterpolate(isSwapped.value ? unref(form).flight_time : unref(form).ferry_time)}</p></div></div></div>`);
        _push(ssrRenderComponent(_component_DashLine, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
...
//# sourceMappingURL=_id_-Br775xSn.mjs.map

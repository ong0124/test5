...
const _routes = [
  ...
  },
  {
    name: "index___en-US",
    path: "/en-US",
    component: () => import('./index-BEin2WjA.mjs')
  },
  {
    name: "index___zh-CN",
    path: "/zh-CN",
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CcoFBtTw.mjs').then((m) => m.default || m))
};
...
export { D, FORMAT_DEFAULT as F, MS as M, Q, W, Y, _export_sfc as _, __nuxt_component_2$1 as a, useI18n as b, useRoute as c, dayjs as d, useRouter as e, M as f, useNuxtApp as g, useAppConfig as h, useRuntimeConfig as i, injectHead as j, asyncDataDefaults as k, createError as l, navigateTo as n, resolveUnrefHeadInput as r, server as s, useLocalePath as u };

...
import { b as useI18n, d as dayjs, a as __nuxt_component_2$1 } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data), (index) => {
        ...
        if (index.trip_type === "roundTrip") {
          ...
          _push(`<div><p class="text-sm text-gray-500">${ssrInterpolate(_ctx.$t("Booking.shuttleBusTime"))}</p><p class="text-md font-semibold text-gray-800">${ssrInterpolate(formatDate(index.return_shuttle_date))} ${ssrInterpolate(index.return_shuttle_time)}</p></div></div></div></div></div>`);
        } else {
          _push(`<!---->`);
        }
...
//# sourceMappingURL=_id_-B5nJ3zE_.mjs.map

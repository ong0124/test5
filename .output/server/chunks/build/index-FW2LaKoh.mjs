  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isSwapped.value) {
        ...
        _push(`<p class="text-lwm-500">${ssrInterpolate(_ctx.$t("Booking.flightDeparture"))}</p></div><div class="border rounded-lg"><select class="flex-1 px-2 py-1 w-full bg-white rounded-lg focus:outline-none text-sm"><option disabled value=""${ssrIncludeBooleanAttr(Array.isArray(flight_loc.value) ? ssrLooseContain(flight_loc.value, "") : ssrLooseEqual(flight_loc.value, "")) ? " selected" : ""}>${ssrInterpolate(_ctx.$t("Booking.required"))}</option><option value="TSA"${ssrIncludeBooleanAttr(Array.isArray(flight_loc.value) ? ssrLooseContain(flight_loc.value, "TSA") : ssrLooseEqual(flight_loc.value, "TSA")) ? " selected" : ""}>\u677E\u5C71 (TSA)</option><option value="RMQ"${ssrIncludeBooleanAttr(Array.isArray(flight_loc.value) ? ssrLooseContain(flight_loc.value, "RMQ") : ssrLooseEqual(flight_loc.value, "RMQ")) ? " selected" : ""}>\u53F0\u4E2D (RMQ)</option><option value="CYI"${ssrIncludeBooleanAttr(Array.isArray(flight_loc.value) ? ssrLooseContain(flight_loc.value, "CYI") : ssrLooseEqual(flight_loc.value, "CYI")) ? " selected" : ""}>\u5609\u7FA9 (CYI)</option><option value="TNN"${ssrIncludeBooleanAttr(Array.isArray(flight_loc.value) ? ssrLooseContain(flight_loc.value, "TNN") : ssrLooseEqual(flight_loc.value, "TNN")) ? " selected" : ""}>\u53F0\u5357 (TNN)</option><option value="MZG"${ssrIncludeBooleanAttr(Array.isArray(flight_loc.value) ? ssrLooseContain(flight_loc.value, "MZG") : ssrLooseEqual(flight_loc.value, "MZG")) ? " selected" : ""}>\u6F8E\u6E56 (MZG)</option></select></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
...
//# sourceMappingURL=index-FW2LaKoh.mjs.map

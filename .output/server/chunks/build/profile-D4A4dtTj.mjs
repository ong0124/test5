...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex flex-col flex-1"><p>${ssrInterpolate(unref(userStore).user_name || _ctx.$t("profile.nickname"))}</p><div class="flex"></div></div></div></div><div class="bg-gray-100 rounded-t-3xl shadow h-screen pt-4"><div class="flex p-2 justify-between bg-white rounded-lg mx-4 mb-2 shadow-sm"><!--[-->`);
...
//# sourceMappingURL=profile-D4A4dtTj.mjs.map

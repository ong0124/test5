...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isSwapped.value) {
        _push(`<div class="flex pb-1"><div class="flex flex-col"><div class="flex">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "lucide:tickets",
          class: "bg-lwm-50 w-6 h-6"
        }, null, _parent));
        _push(`<p class="text-lwm-500">${ssrInterpolate(_ctx.$t("Booking.flightNumber"))}</p></div><div class="border rounded-lg mr-2"><input type="text"${ssrRenderAttr("placeholder", _ctx.$t("Booking.required"))}${ssrRenderAttr("value", flightNumber.value)} class="px-2 py-1 w-full bg-white rounded-lg focus:outline-none text-sm"></div></div><div class="flex flex-col"><div class="flex pr-4">`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "uil-plane-departure",
          class: "bg-lwm-50 w-6 h-6"
        }, null, _parent));
        _push(`<p class="text-lwm-500">${ssrInterpolate(_ctx.$t("Booking.flightDeparture"))}</p></div><div class="border rounded-lg"><select class="flex-1 px-2 py-1 w-full bg-white rounded-lg focus:outline-none text-sm"><option disabled value=""${ssrIncludeBooleanAttr(Array.isArray(flightDeparture.value) ? ssrLooseContain(flightDeparture.value, "") : ssrLooseEqual(flightDeparture.value, "")) ? " selected" : ""}>${ssrInterpolate(_ctx.$t("Booking.required"))}</option><option value="TSA"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture.value) ? ssrLooseContain(flightDeparture.value, "TSA") : ssrLooseEqual(flightDeparture.value, "TSA")) ? " selected" : ""}>\u677E\u5C71 (TSA)</option><option value="RMQ"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture.value) ? ssrLooseContain(flightDeparture.value, "RMQ") : ssrLooseEqual(flightDeparture.value, "RMQ")) ? " selected" : ""}>\u53F0\u4E2D (RMQ)</option><option value="CYI"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture.value) ? ssrLooseContain(flightDeparture.value, "CYI") : ssrLooseEqual(flightDeparture.value, "CYI")) ? " selected" : ""}>\u5609\u7FA9 (CYI)</option><option value="TNN"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture.value) ? ssrLooseContain(flightDeparture.value, "TNN") : ssrLooseEqual(flightDeparture.value, "TNN")) ? " selected" : ""}>\u53F0\u5357 (TNN)</option><option value="MZG"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture.value) ? ssrLooseContain(flightDeparture.value, "MZG") : ssrLooseEqual(flightDeparture.value, "MZG")) ? " selected" : ""}>\u6F8E\u6E56 (MZG)</option></select></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isSwapped.value) {
        ...
        _push(`<p class="text-lwm-500">${ssrInterpolate(_ctx.$t("Booking.flightDeparture"))}</p></div><div class="border rounded-lg"><select class="flex-1 px-2 py-1 w-full bg-white rounded-lg focus:outline-none text-sm"><option disabled value=""${ssrIncludeBooleanAttr(Array.isArray(flightDeparture2.value) ? ssrLooseContain(flightDeparture2.value, "") : ssrLooseEqual(flightDeparture2.value, "")) ? " selected" : ""}>${ssrInterpolate(_ctx.$t("Booking.required"))}</option><option value="TSA"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture2.value) ? ssrLooseContain(flightDeparture2.value, "TSA") : ssrLooseEqual(flightDeparture2.value, "TSA")) ? " selected" : ""}>\u677E\u5C71 (TSA)</option><option value="RMQ"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture2.value) ? ssrLooseContain(flightDeparture2.value, "RMQ") : ssrLooseEqual(flightDeparture2.value, "RMQ")) ? " selected" : ""}>\u53F0\u4E2D (RMQ)</option><option value="CYI"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture2.value) ? ssrLooseContain(flightDeparture2.value, "CYI") : ssrLooseEqual(flightDeparture2.value, "CYI")) ? " selected" : ""}>\u5609\u7FA9 (CYI)</option><option value="TNN"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture2.value) ? ssrLooseContain(flightDeparture2.value, "TNN") : ssrLooseEqual(flightDeparture2.value, "TNN")) ? " selected" : ""}>\u53F0\u5357 (TNN)</option><option value="MZG"${ssrIncludeBooleanAttr(Array.isArray(flightDeparture2.value) ? ssrLooseContain(flightDeparture2.value, "MZG") : ssrLooseEqual(flightDeparture2.value, "MZG")) ? " selected" : ""}>\u6F8E\u6E56 (MZG)</option></select></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex">`);
...
//# sourceMappingURL=index-Ck5KFizn.mjs.map

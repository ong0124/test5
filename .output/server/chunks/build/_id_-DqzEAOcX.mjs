...
import { T as Translate_loc } from './Translate_loc-2iMZA2qi.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` ${ssrInterpolate(_ctx.$t("announcementMessage"))}\xA0${ssrInterpolate(":")}\xA0 <div class="marquee-container flex-1 overflow-hidden"><div class="whitespace-nowrap animate-marquee"><span class="px-4">${ssrInterpolate(_ctx.$t("ReschedulePage.message"))}</span></div></div></div><div class="px-6 pt-4"><div class="bg-amber-50 p-4 rounded-lg flex flex-col border-b-2 border-dashed"><div class="border-l-4 border-orange-300 text-gray-500"><p class="mx-2 text-lg font-bold">${ssrInterpolate(_ctx.$t("ReschedulePage.originalSchedule"))}</p></div><div class="text-gray-500"><div class="flex"><div class="flex-1 self-center"><p class="text-end">${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).departure_loc))}</p></div><div class="flex-1 flex-col text-center"><div class="border-b-2 border-dashed mx-4 border-lwm-400 text-sm"><p>${ssrInterpolate(formatDate(unref(form).shuttle_date))}</p></div><div class="text-sm"><p>${ssrInterpolate(unref(form).shuttle_time)}</p></div></div><div class="flex-1 self-center"><p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).destination_loc))}</p></div></div><div class="grid grid-cols-2 pt-4"><div class="flex-col text-start ml-14"><p>${ssrInterpolate(showFlightOrFerryTitle.value)}</p><p>${ssrInterpolate(_ctx.$t("Booking.contact"))}</p><p>${ssrInterpolate(_ctx.$t("Booking.phone"))}</p><p>${ssrInterpolate(_ctx.$t("Booking.adultTicket"))}</p><p>${ssrInterpolate(_ctx.$t("Booking.childTicket1"))}</p></div><div class="flex-col text-start ml-5"><p>${ssrInterpolate(showFlightOrFerry.value)}</p><p>${ssrInterpolate(unref(form).contact_name)}</p><p>${ssrInterpolate(unref(form).contact_phone)}</p><p>${ssrInterpolate(unref(form).adult_num)}</p><p>${ssrInterpolate(unref(form).child_num)}</p></div></div></div></div>`);
      if (unref(form).trip_type === "roundTrip") {
        _push(`<div><div class="bg-amber-50 p-4 rounded-lg flex flex-col border-b-2"><div class="border-l-4 border-orange-300 text-gray-500"><p class="mx-2 text-lg font-bold">${ssrInterpolate(_ctx.$t("Booking.return"))}</p></div><div class="text-gray-500"><div class="flex"><div class="flex-1 self-center"><p class="text-end">${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_departure))}</p></div><div class="flex-1 flex-col text-center"><div class="border-b-2 border-dashed mx-4 border-lwm-400 text-sm"><p>${ssrInterpolate(formatDate(unref(form).return_shuttle_date))}</p></div><div class="text-sm"><p>${ssrInterpolate(unref(form).return_shuttle_time)}</p></div></div><div class="flex-1 self-center"><p>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_destination))}</p></div></div><div class="grid grid-cols-2 pt-4"><div class="flex-col text-start ml-14"><p>${ssrInterpolate(ReturnshowFlightOrFerryTitle.value)}</p><p>${ssrInterpolate(_ctx.$t("Booking.contact"))}</p><p>${ssrInterpolate(_ctx.$t("Booking.phone"))}</p><p>${ssrInterpolate(_ctx.$t("Booking.adultTicket"))}</p><p>${ssrInterpolate(_ctx.$t("Booking.childTicket1"))}</p></div><div class="flex-col text-start ml-5"><p>${ssrInterpolate(ReturnshowFlightOrFerry.value)}</p><p>${ssrInterpolate(unref(form).contact_name)}</p><p>${ssrInterpolate(unref(form).contact_phone)}</p><p>${ssrInterpolate(unref(form).adult_num)}</p><p>${ssrInterpolate(unref(form).child_num)}</p></div></div></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (isSwapped.value) {
        _push(`<span class="text-blue-500">${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).destination_loc))}</span>`);
      } else {
        _push(`<span>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).departure_loc))}</span>`);
      }
      _push(`</p>`);
      _push(ssrRenderComponent(_component_Icon, {
      ...
      if (isSwapped.value) {
        _push(`<span class="text-blue-500">${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).departure_loc))}</span>`);
      } else {
        _push(`<span>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).destination_loc))}</span>`);
      }
      _push(`</p></div>`);
      if (unref(form).trip_type === "roundTrip") {
        ...
        if (isSwapped.value) {
          _push(`<span class="text-blue-500">${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_destination))}</span>`);
        } else {
          _push(`<span>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_departure))}</span>`);
        }
        _push(`</p>`);
        _push(ssrRenderComponent(_component_Icon, {
          name: "fa6-solid:rotate",
        ...
        _push(`<p class="font-medium text-gray-700">`);
        if (isSwapped.value) {
          _push(`<span class="text-blue-500">${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_departure))}</span>`);
        } else {
          _push(`<span>${ssrInterpolate(("Translate_loc" in _ctx ? _ctx.Translate_loc : unref(Translate_loc))(unref(form).return_destination))}</span>`);
        }
        _push(`</p></div><!--]-->`);
      } else {
        _push(`<!---->`);
...
//# sourceMappingURL=_id_-DqzEAOcX.mjs.map
